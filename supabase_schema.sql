...
-- Allows public anonymous reads and user reviews/comments insertion
-- ============================================================
...
-- Read policies (Public anonymous access)
...
CREATE POLICY "Allow public read access on reviews" ON public.reviews FOR SELECT USING (status = 'approved');
CREATE POLICY "Allow public read access on comments" ON public.comments FOR SELECT USING (status = 'approved');
CREATE POLICY "Allow public read access on chatbot_responses" ON public.chatbot_responses FOR SELECT USING (true);

-- Insert policies (Allow public users to submit reviews and comments)
